...
A comprehensive guide organized by what you're trying to accomplish. Find your situation, see example prompts, and get started immediately.
...
- Use the [Agent Pipelines](#agent-pipelines) section for multi-agent workflows
...
**See Also:** [Creative Ideation Pipeline](#creative-ideation-pipeline)
...
**See Also:** [Multiplayer Development Pipeline](#multiplayer-development-pipeline)
...
**See Also:** [Procedural Generation Pipeline](#procedural-generation-pipeline)
...
**See Also:** [User Research Pipeline](#user-research-pipeline)
...
**See Also:** [Feature Development Pipeline](#feature-development-pipeline)
...
**See Also:** [Level Design Pipeline](#level-design-pipeline)
...
**See Also:** [Narrative Design Pipeline](#narrative-design-pipeline)
...
**See Also:** [AI Systems Pipeline](#ai-systems-pipeline)
...
**See Also:** [Production Planning Pipeline](#production-planning-pipeline)
...
**See Also:** [Design Iteration Pipeline](#design-iteration-pipeline)
...
**See Also:** [Debugging Pipeline](#debugging-pipeline)
...
**See Also:** [Strategic Decision Pipeline](#strategic-decision-pipeline)
...
**See Also:** [Polish Pipeline](#polish-pipeline)
...
**See Also:** [Pre-Launch Pipeline](#pre-launch-pipeline)
...
**See Also:** [Platform Certification Pipeline](#platform-certification-pipeline)
...
**See Also:** [Live Operations Pipeline](#live-operations-pipeline)
...
**See Also:** [Monetization Design Pipeline](#monetization-design-pipeline)
...
**See Also:** [Social Systems Pipeline](#social-systems-pipeline)
...
This section describes common agent chaining patterns for different game development tasks. Each workflow shows which agents to use and in what order for maximum effectiveness.
